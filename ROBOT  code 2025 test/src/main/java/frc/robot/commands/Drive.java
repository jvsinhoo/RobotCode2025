...
/**
 * An example command that uses an example subsystem.h
 */
public class Drive extends Command {
    ...
    private final XboxController controlSwerve = new XboxController(1);
     ...
     *                          wall.
     */
    public Drive(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingHorizontal,
    ...
    public double maxSpeed(){
        if(controlSwerve.getRawAxis(4) != 0){
            return 1;
        }
        return 4.0;
    }
    ...
    public void execute() {
        ...
        translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                Dimensoes.LOOP_TIME, Constants.Dimensoes.ROBOT_MASS, List.of(Constants.Dimensoes.CHASSIS),
